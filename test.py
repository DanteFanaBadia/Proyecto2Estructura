...
class Test(unittest.TestCase):
    ...
    def test_usuario_no_disponible(self):
        ...
        sn.insertar(user_4)
        sn.insertar(user_5)
        self.assertEqual(True, sn.usuario_disponible(user_1.username))
    ...
    def test_distance_2(self):
        ...
        sn.insertar(user_2)
        sn.insertar(user_3)
        sn.friend(user_1, user_2)
        sn.friend(user_2, user_3)
        sn.friend(user_3, user_1)
    ...
    def test_distance_infinity(self):
        ...
        sn.friend(user_1, user_2)
        sn.friend(user_2, user_3)
        sn.friend(user_3, user_4)
        sn.friend(user_4, user_5)
        sn.friend(user_5, user_6)
        sn.friend(user_6, user_7)
        sn.friend(user_7, user_8)
        sn.friend(user_8, user_9)
        sn.friend(user_9, user_10)
        sn.friend(user_10, user_11)
        sn.friend(user_11, user_12)
        sn.friend(user_12, user_1)
    ...
    def test_tamano_red_de_familia_eq_4(self):
        ...
        sn.insertar(user_4)
        sn.friend(user_1, user_2)
        sn.friend(user_2, user_1)
        sn.friend(user_2, user_3)
        sn.friend(user_2, user_4)
